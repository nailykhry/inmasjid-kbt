    ...
    <div class="container mt-5 container-home">
        ...
        <div class="row pb-5 list-margin-card">
            <div class="col-md-4 d-flex align-items-stretch">
                <a class="card bg-purple border border-0 flex-grow-1 m-4" href="{{ url('/ads/create') }}">
                    <div class="card-body">
            ...
            <div class="col-md-4 d-flex align-items-stretch">
                <a class="card bg-yellow border border-0 flex-grow-1 m-4" href="{{ url('/daftar-barang') }}">
                    <div class="card-body">
