  ...
  <body>
    ...
    <nav class="navbar py-2">
      <div class="container-fluid d-lg-none d-flex flex-column gap-2">
        ...
        <div class="d-flex w-100 justify-content-between">
          <a class="navbar-brand flex-sm-grow-1" href="/">
            <img src="{{ asset('assets/images/inmasjid.png') }}" class="img-fluid" style="max-height: 50px !important">
          </a>
              ...
              @auth
                <li class="nav-item">
                  <div class="d-grid gap-2">
                    <a class="btn btn-warning" href="/ads/create">
      ...
      <div class="container d-none d-lg-flex justify-content-between">
        ...
        @auth 
          <form class="w-25">
            <div class="input-group input-group-lg d-flex" style="background-color: #F0F0F0">
              ...
              <input name="search" type="text" class="form-control border-start-0 border-dark" placeholder="Masjid" style="background-color: #F0F0F0">
            </div>
          </form>

          <form class="w-25">
              <div class="input-group input-group-lg d-flex" style="background-color: #F0F0F0">
                <input name="search" type="text" class="form-control border-end-0 border-dark" placeholder="Cari barang" style="background-color: #F0F0F0">
                <button type="submit" class="btn btn-outline-secondary border-start-0 border-dark">
                  <i class="fa-solid fa-magnifying-glass"></i>
                </button>
              </div>
        ...
        <ul class="navbar-nav d-flex flex-row @auth justify-content-around @else justify-content-end @endauth align-items-center gap-4">
          @auth  
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="#">Last Item</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="#">Found Item</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="btn btn-register" href="{{ url('register') }}">
                Create Free Account
              </a>
            </li>    
            @endauth
            @auth
            <li class="nav-item">
              <a class="btn btn-warning rounded-pill text-white px-4" href="/ads/create">
                <i class="fa-solid fa-plus"></i>
              </a>
            </li>     
            @endauth
