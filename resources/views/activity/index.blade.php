...
@section('content')
    ...
    <div class="pt-5 my-5">
        ...
        <div class="container my-5">
            ...
            <div class="row row-cols-1 py-5 px-3">

                    <div class="col mb-3">
                        <div class="row rows-cols-1">
                            <div class="col">
                                <a href="/my-requests/{{ $requests->id }}" class="text-decoration-none">
                                    <div class="card shadow @if ($selected_request && $requests->id == $selected_request->id) bg-info @endif"
                                        style="max-width: 450px">
                                        <div class="row g-0">
                                            <div class="col-lg-6 col-md-12">
                                                <img src="{{ asset('images/inventories/' . $requests->inventory->foto) }}"
                                                    class="w-100 h-100 rounded-start" alt="...">
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="card-body">
                                                    <h5 class="card-title">{{ $requests->nama_barang }}</h5>
                                                    <p class="card-text mb-0">{{ $requests->lokasi }}</p>
                                                    <p class="card-text mb-0">Jumlah pengajuan : {{ $requests->stok }}</p>
                                                    <div class="d-flex justify-content-between">
                                                        <div class="card-text">
                                                            <p class="mb-0">Order at : </p>
                                                            <p class="mb-0">{{ $requests->tanggal_pengajuan }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col">
                                <ul class="stepper stepper-vertical mt-0 pt-0">
                                    ...
                                    @foreach ($requests->statuses as $key => $status)
                                        <li class="completed">
