    ...
    <div class="container mt-5">
        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                ...
                <form class="row p-5" action="{{ route('auth') }}" method="post">
                    @csrf
                    ...
                    <div class="col-12 form-group mb-3">
                        <button type="submit"
                            class="btn btn-primary btn-login-submit btn-lg mt-3 w-100 d-flex justify-content-between">Login
                            <img src="{{ asset('assets/images/arrow-right.png') }}" alt="Right"></button>
                    </div>
                    <div class="text-center">
                        <span>Don’t have an account? <a href="{{ route('users.create') }}"
                                class="fw-medium">Register</a>
                        </span>
                    </div>
                </form>
            </div>
            ...
            <div class="row align-items-center justify-content-center p-auto gap-3">
                ...
                <form class="row g-3" action="/login" method="post">
                    ...
                    <div class="col-12 form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control form-control-lg"
                            placeholder="Masukkan Email MySpareLog anda">
                    </div>
                    <div class="col-12 form-group">
                        <label class="form-label" for="password">Password</label>
                        <input type="password" name="password" id="password" class="form-control form-control-lg"
                            placeholder="Masukkan Password MySpareLog anda">
                    </div>
                    <div class="col-12 form-group">
