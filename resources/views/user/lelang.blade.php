        ...
        <main class="col ps-md-2 pt-2">
            <div class="card border-0 shadow p-4">
                ...
                <div class="d-flex gap-2 mb-3">
                    <a href="{{route('my-inventories.download-excel', ['status' => 'lelang'])}}" class="btn btn-success">Download Excel</a>
                </div>
                <table class="table">
                    <thead>
                        <tr class="table-info">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-3 justify-content-center">
                                    <form action="{{ url('my-inventories/change-status/'.$inventory->id) }}" method="POST" onsubmit="return confirm('Are you sure?')" class="m-0">
                                        @csrf
                                        <button type="submit" name="status" value="tersedia" class="btn btn-primary rounded-5 px-4">Cancel</button>
                                    </form>
