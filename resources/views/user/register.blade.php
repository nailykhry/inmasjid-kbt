            ...
            <div class="col-md-4">
                ...
                <form class="row p-5">
                    ...
                    <div class="col-12 form-group mb-2">
                        ...
                        <input type="text" name="username" id="username" class="form-control form-control-lg" placeholder="Enter your name">
                    </div>
                    <div class="col-12 form-group mb-2">
                    ...
                    <div class="col-12 form-group">
                        <label class="form-label fw-medium" for="confirm_password">Confirm Password</label>
                        <input type="password" name="confirm_password" id="confirm_password" class="form-control form-control-lg" placeholder="Enter confirm pasword">
                    </div>
                    <div class="col-12 form-group mb-3">
                        <button type="submit" class="btn btn-primary btn-login-submit btn-lg mt-3 w-100 d-flex justify-content-between">Register <img src="{{ asset('assets/images/arrow-right.png') }}" alt="Right"></button>
                    </div>
