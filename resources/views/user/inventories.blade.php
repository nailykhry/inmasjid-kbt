        ...
        <main class="col ps-md-2 pt-2">
            <div class="card border-0 shadow p-4">
                ...
                <div class="d-flex gap-2 mb-3">
                    <a href="{{route('my-inventories.download-excel', ['status' => ''])}}" class="btn btn-success">Download Excel</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-3 justify-content-center">
                                    <a href="{{ url('inventory/edit/'.$inventory->id) }}" class="btn btn-primary rounded-5 px-4">Edit</a>
...
<script>
    ...
    $('.btn-view').click(function (e) {
        ...
        $('#imgBarang').attr('src', 'images/inventories/'+img);
        $('#viewPIC').html(pic);
        $('#viewNama').html(nama);
        $('#viewLokasi').html(loc);
