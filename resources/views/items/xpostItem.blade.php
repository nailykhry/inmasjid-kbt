    ...
    <div class="row px-2">
        <div class="col-6 d-flex flex-column p-0 gap-3">
            <div class="btn-group dropend">
                <button type="button"
                    class="p-3 fs-4 d-flex justify-content-between align-items-center btn btn-light text-secondary shadow-sm dropdown-toggle"
                    data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="-1,10">
                    <span><i class="fas fa-screwdriver-wrench"></i> Peralatan Faspel</span>
                </button>
                <div class="dropdown-menu w-100 p-0 m-0 fs-4 border-0">
                    <a class="p-3 dropdown-item mb-3 rounded-3 shadow-sm text-decoration-none text-secondary"
                        href="/ads/create/{{1}}">
                        CC
                    </a>
                    <a class="p-3 dropdown-item mb-3 rounded-3 shadow-sm text-decoration-none text-secondary"
            ...
            <a class="p-3 fs-4 d-flex justify-content-between align-items-center btn btn-light text-secondary shadow-sm"
                href="/ads/create/{{7}}">
